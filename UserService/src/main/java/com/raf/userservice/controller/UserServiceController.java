...
public class UserServiceController {
    ...
    public ResponseEntity passwordResetRequest(@RequestBody @Valid PasswordResetRequestDto passwordResetRequestDto) {
        userService.passwordResetRequest(passwordResetRequestDto);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @PostMapping("/passwordreset")
    public ResponseEntity passwordReset(@RequestBody @Valid TokenRequestDto tokenRequestDto) {
        userService.passwordReset(tokenRequestDto);
        return new ResponseEntity<>(HttpStatus.OK);
    }
