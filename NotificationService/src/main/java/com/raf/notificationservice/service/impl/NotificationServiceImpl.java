...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Override
    public Page<Notification> findAllNotificationsForUser(Pageable pageable, Long userId) {
        UserDto userDto = Retry.decorateSupplier(userServiceRetry, () -> getUserDto( userId)).get();
