...
public class NotificationServiceController {
    ...
    public ResponseEntity<Page<Notification>> getNotificationsByUser(@RequestHeader("Authorization") String authorization,@PathVariable Long userId, Pageable pageable){
        return new ResponseEntity<>(notificationService.findAllNotificationsForUser(pageable, userId), HttpStatus.OK);
    }
